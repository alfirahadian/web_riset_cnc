    ...
    <div class="container">
      <div class="nav-wrapper">
        ...
        <ul id="nav-mobile" class="right hide-on-med-and-down">
          <li>Selamat Datang, <?php echo $this->session->userdata('nama');?></li>
          <li></li>
        </ul>
      </div>
    </div>
                ...
                <div class="nav-wrapper blue-grey darken-4 experience-buttons">
                    <div class="col-xs z-depth-2">
                        <div class="input-field col s12 l12 m12" style="text-align: left;font-size: 17px;">
                          ...
                          <div class="container">
                            <span>MY RESEARCH MILESTONE</span>
                            <div class="right"><a href="user/logout" class="waves-effect waves-light btn pink">Logout</a></div>
                          </div>
                          </div>
                        </div>
                    </div>
      ...
      <div class="row col s12 m12 l6">
        ...
        <tbody>
          <tr>
            ...
            <td><a class="waves-effect waves-light btn">UPLOAD</a>
            </td>
          </tr>
          <tr>
